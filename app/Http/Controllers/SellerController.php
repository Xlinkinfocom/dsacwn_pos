...
class SellerController extends Controller
{
    ...
    {        
        ...
        if($role->hasPermissionTo('users-edit')){            
            ...
            return view('seller.edit', compact('lims_user_data', 'lims_role_list', 'seller', 'states', 'districts', 'bdistricts', 'isNew'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        else
        {
            ...
            {
                $panno_image = $seller->panno_image;
            }
            ...
            {
                $gst_document = $seller->gst_document;
            }
            ...
            {
                $citizenship_document = $seller->citizenship_document;
            }
            ...
            {
                $passportsizephoto = $seller->passportsizephoto;
            }
