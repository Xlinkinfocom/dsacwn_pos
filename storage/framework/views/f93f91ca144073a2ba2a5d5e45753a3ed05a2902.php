...
<section>
    <div class="container-fluid">
        <?php if(in_array("sales-add", $all_permission)): ?>
            <a href="<?php echo e(route('sale.pos')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add Sale')); ?></a>
        <?php endif; ?>
    </div>
    <div class="table-responsive">
        <table id="quick-sale-table" class="table sale-list" style="width: 100%">
            <thead>
                <tr>
...
<div id="view-payment"z tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
...
<script type="text/javascript">
    ...
    $("ul#sale #quick-sale-list-menu").addClass("active");
    ...
    function saleDetails(sale){
        ...
        $.get('quick_product_sale/' + sale[13], function(data){
        ...
        var htmlfooter = '<p><strong><?php echo e(trans("file.Sale Note")); ?>:</strong> '+sale[23]+'</p><p><strong><?php echo e(trans("file.Staff Note")); ?>:</strong> '+sale[24]+'</p><p><strong><?php echo e(trans("Payment Note")); ?>:</strong> '+sale[31]+'</p><p><strong><?php echo e(trans("Payment Method")); ?>:</strong> '+sale[30]+'</p><p><strong><?php echo e(trans("By Cash")); ?>:</strong> '+sale[32]+'</p><p><strong><?php echo e(trans("By Card")); ?>:</strong> '+sale[33]+'</p><p><strong><?php echo e(trans("Change")); ?>:</strong> '+sale[34]+'</p><strong><?php echo e(trans("file.Created By")); ?>:</strong><br>'+sale[25]+'<br>'+sale[26];
    ...
    if(all_permission.indexOf("quick-sales-delete") == -1)
