      ...
      <div class="container">
        <div class="form-outer text-center d-flex align-items-center">
          <div class="form-inner">
            ...
            <p><?php echo e(trans('file.Do not have an account?')); ?> yes</p>
            <a href="<?php echo e(url('register')); ?>" class="signup"><?php echo e(trans('file.Register')); ?></a> | <a href="<?php echo e(route('seller_register')); ?>" class="signup">Register Seller</a>
          </div>
          <div class="copyrights text-center">
            <p><?php echo e(trans('file.Developed By')); ?> <a href="https://www.sunshiene.com/" class="external">Sunshiene Softech</a></p>
          </div>
        </div>
      </div>
    </div>
