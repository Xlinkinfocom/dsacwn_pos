                    ...
                    <div class="card-body">
						...
						<div class="table-responsive">
						    <table class="table table-bordered permission-table">
						        ...
						        <!-- quick sale start -->
						        <tr>
						            <td><?php echo e(trans('Quick Sale')); ?></td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("quick-sales-index", $all_permission)): ?>
								                <input type="checkbox" value="1" id="quick-sales-index" name="quick-sales-index" checked />
								                <?php else: ?>
								                <input type="checkbox" value="1" id="quick-sales-index" name="quick-sales-index">
								                <?php endif; ?>
								                <label for="quick-sales-index"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						                <div class="icheckbox_square-blue checked" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("quick-sales-add", $all_permission)): ?>
								                <input type="checkbox" value="1" id="quick-sales-add" name="quick-sales-add" checked />
								                <?php else: ?>
								                <input type="checkbox" value="1" id="quick-sales-add" name="quick-sales-add">
								                <?php endif; ?>
								                <label for="quick-sales-add"></label>
								            </div>
						            	</div>
						            </td>
						            <td class="text-center">
						            ...
						            <td class="text-center">
						                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
							                <div class="checkbox">
								                <?php if(in_array("quick-sales-delete", $all_permission)): ?>
								                <input type="checkbox" value="1" id="quick-sales-delete" name="quick-sales-delete" checked>
								                <?php else: ?>
								                <input type="checkbox" value="1" id="quick-sales-delete" name="quick-sales-delete">
								                <?php endif; ?>
								                <label for="quick-sales-delete"></label>
								            </div>
						            	</div>
						            </td>
						        </tr>
