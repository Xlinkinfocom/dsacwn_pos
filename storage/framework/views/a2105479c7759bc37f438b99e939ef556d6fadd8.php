    ...
    <div id="receipt-data">
        ...
        <table>
            <tbody>
                ...
                <?php 
                    $product_name = $product_sale_data->product_name;
                ?>
                <tr><td colspan="2"><?php echo e($product_name); ?><br><?php echo e($product_sale_data->qty); ?> x <?php echo e(number_format((float)(($product_sale_data->total - $product_sale_data->tax) / $product_sale_data->qty), 2, '.', '')); ?></td>
                    <td style="text-align:right;vertical-align:bottom"><?php echo e(number_format((float)(($product_sale_data->total - $product_sale_data->tax) / $product_sale_data->qty), 2, '.', '')); ?></td>
                </tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <th style="text-align:right"><?php echo e(number_format((float)$lims_sale_data->total_price - $lims_sale_data->total_tax, 2, '.', '')); ?></th>
                </tr>
                <?php if($lims_sale_data->total_tax): ?>
                <tr>
                    <th colspan="2"><?php echo e(trans('file.Order Tax')); ?></th>
                    <th style="text-align:right"><?php echo e(number_format((float)$lims_sale_data->total_tax, 2, '.', '')); ?></th>
                </tr>
                <?php endif; ?>
                <tr>
        ...
        <table>
            <tbody>
                <tr style="background-color:#ddd;">
                    <td style="padding: 5px;width:30%"><?php echo e(trans('file.Paid By')); ?>: <?php echo e($lims_sale_data->paying_method); ?></td>
                    <td style="padding: 5px;width:40%"><?php echo e(trans('file.Amount')); ?>: <?php echo e(number_format((float)$lims_sale_data->grand_total, 2, '.', '')); ?></td>
                    <td style="padding: 5px;width:30%"><?php echo e(trans('file.Change')); ?>: <?php echo e(number_format((float)$lims_sale_data->quick_change, 2, '.', '')); ?></td>
                </tr>
