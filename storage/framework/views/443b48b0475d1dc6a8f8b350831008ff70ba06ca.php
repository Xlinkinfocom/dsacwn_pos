        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
                            <button style="background-color: #b33771" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="cash-card-btn"><i class="fa fa-credit-card-alt"></i> Mix Payment</button>
                        </div>
                        <div class="column-5">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6 mt-1">
                                            <label style="color: blue;font-size: x-large;"><?php echo e(trans('file.Recieved Amount')); ?> *</label>
                                            <input type="text" name="paying_amount" class="form-control numkey" required step="any" value="">
                                        </div>
                                        <div class="col-md-6 mt-1">
                                            <label style="color: red;font-size: x-large;"><?php echo e(trans('file.Paying Amount')); ?> *</label>
                                            <input type="text" name="paid_amount" class="form-control numkey"  step="any">
                                        </div>


                                        <div class="col-md-6 mt-1 by_cc">
                                            <label style="color: grey;font-size: x-large;"><?php echo e(trans('By Cash')); ?> *</label>
                                            <input type="text" name="by_cash" id="by_cash" class="form-control numkey" step="any" value="">
                                        </div>
                                        <div class="col-md-6 mt-1 by_cc">
                                            <label style="color: orange;font-size: x-large;"><?php echo e(trans('By Card')); ?> *</label>
                                            <input type="text" name="by_card" id="by_card" class="form-control numkey" step="any" value="">
                                        </div>


                                        <div class="col-md-6 mt-1">
                                            <label style="color: green;font-size: x-large;"><?php echo e(trans('file.Change')); ?> : </label>
                                        ...
                                        <div class="col-md-6 mt-1">
                                            ...
                                            <select name="paid_by_id_select" class="form-control selectpicker">
                                                ...
                                                <option value="7">Mix Payment</option>
            ...
            <div class="col-md-6">
                        ...
                        <div class="navbar-holder d-flex align-items-center justify-content-between">
                          ...
                          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            <li class="nav-item">
                              ...
                              <?php 
                                $add_quick_permission = DB::table('permissions')->where('name', 'quick-sales-add')->first();
                                $add_quick_permission_active = DB::table('role_has_permissions')->where([
                                    ['permission_id', $add_quick_permission->id],
                                    ['role_id', $role->id]
                                ])->first();
                              ?>
                              <?php if($add_quick_permission_active): ?>
                                <button style="background-color: #fd7272;padding: 4px 10px;" type="button" class="btn btn-custom" data-toggle="modal" data-target="#quick_sale" id="quick-sale-btn"><i class="fa fa-money"></i> Quick Sale</button>
                              <?php endif; ?>
                            </li>
    			...
    			<div class="row">
                    ...
                    <div class="col-md-3">
                        <!-- <button class="btn btn-block btn-danger" id="featured-filter"><?php echo e(trans('No Sell')); ?></button> -->
                        <a href="<?php echo e(url('sale/demo_invoice')); ?>" class="btn btn-block btn-danger"><?php echo e(trans('Drawer Open')); ?></a>
                    </div>
                    <div class="col-md-3">
                        <button class="btn btn-block btn-success" id="clear_products"><?php echo e(trans('Clear')); ?></button>
                    </div>
            ...
            <form action="quick_store" method="post">
            <!-- quick sale start -->

            <div id="quick_sale" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left" data-backdrop="static" data-keyboard="false">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Quick Sale')); ?></h5>
                            <button type="button" data-dismiss="modal" aria-label="Close" class="close" id="close_quick_sale_modal"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                        </div>
                        <!-- <?php echo Form::open(['route' => 'sales.store', 'method' => 'post', 'files' => true, 'class' => 'payment-form']); ?> -->
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="table-responsive">
                                    <table id="quick_table" class="table table-hover table-striped order-list table-fixed">
                                      <thead>
                                        <tr>
                                          <th class="col-sm-2"><?php echo e(trans('file.product')); ?></th>
                                          <th class="col-sm-2"><?php echo e(trans('file.Price')); ?></th>
                                          <th class="col-sm-2"><?php echo e(trans('Unit')); ?></th>
                                          <th class="col-sm-2"><?php echo e(trans('Tax Rate')); ?></th>
                                          <th class="col-sm-1"><?php echo e(trans('Qty')); ?></th>
                                          <th class="col-sm-3"><?php echo e(trans('file.Subtotal')); ?></th>
                                        </tr>
                                      </thead>
                                      ...
                                      <!-- <tbody>
                                        <tr>
                                          <td class="col-sm-2" style="padding: 4px;padding-bottom: 0px;">
                                            <input type="text" name="pro_name[]" class="form-control" required>
                                          </td>
                                          <td class="col-sm-2" style="padding: 4px;padding-bottom: 0px;">
                                            <input type="text" name="pro_price[]" class="form-control numkey" required step="any">
                                          </td>
                                          <td class="col-sm-2" style="padding: 4px;padding-bottom: 0px;">
                                            <select class="" style="width: 100%;padding: 7px 4px;border: 1px solid #e9ecef;border-radius: 5px;"><option value="Piece">Piece</option><option value="Meter">Meter</option><option value="Grams">Grams</option><option value="KG">KG</option></select><input type="hidden" name="pro_unit[]" class="form-control" required></td><td class="col-sm-2" style="padding: 4px;padding-bottom: 0px;"><div class="form-group"><select name="edit_tax_rate" class="" style="width: 100%;padding: 7px 4px;border: 1px solid #e9ecef;border-radius: 5px;"><?php $__currentLoopData = $tax_name_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($key); ?>"><?php echo e($name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></div></td><td class="col-sm-1" style="padding: 4px;padding-bottom: 0px;"><input type="text" name="pro_qty[]" class="form-control numkey" required step="any"></td><td class="col-sm-2" style="padding: 4px;padding-bottom: 0px;"><input type="text" name="pro_subtotal[]" class="form-control numkey" required step="any" readonly></td><td class="col-sm-1" style="padding: 4px;padding-bottom: 0px;"><button type="button" class="btn btn-danger btn-sm"><i class="dripicons-cross"></i></button></td></tr>
                                      </tbody> -->


                                      <!-- <tbody style="margin-bottom: 200px;">
                                        <tr>
                                          <td class="col-sm-2" style="padding-left: 4px;padding-right: 4px;">
                                            <input type="text" name="pro_name[]" class="form-control" required>
                                          </td>
                                          <td class="col-sm-2" style="padding-left: 4px;padding-right: 4px;">
                                            <input type="text" name="pro_price[]" class="form-control numkey" required step="any">
                                          </td>
                                          <td class="col-sm-2" style="padding-top: 16px;padding-left: 8px;padding-right: 15px;">
                                            ...
                                            <input type="hidden" name="pro_unit[]" class="form-control" required>
                                          </td>
                                          <td class="col-sm-2" style="padding-top: 16px;padding-left: 8px;padding-right: 20px;">
                                            <div class="form-group">
                                                <select name="edit_tax_rate" class="form-control selectpicker">
                                                    <?php $__currentLoopData = $tax_name_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>"><?php echo e($name); ?></option>
                                          ...
                                          <td class="col-sm-1" style="padding-left: 4px;padding-right: 4px;">
                                            <input type="text" name="pro_qty[]" class="form-control numkey" required step="any">
                                          </td>
                                          <td class="col-sm-2" style="padding-left: 4px;padding-right: 4px;">
                                            <input type="text" name="pro_subtotal[]" class="form-control numkey" required step="any" readonly>
                                          </td>
                                          <td class="col-sm-1" style="padding-left: 4px;padding-right: 4px;">
                                            <button type="button" class="btn btn-danger btn-sm"><i class="dripicons-cross"></i></button>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td class="col-sm-2" style="padding-left: 4px;padding-right: 4px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                          <button type="button" class="btn btn-success add_pro_item" style="float: right;margin-top: -80px;margin-right: 20px;">
                                            <i class="fa fa-cart-plus"></i>
                                          </button>
                                        </div>

                                        <div class="col-md-12 mt-1">
                                          <div style="background: #d6deff;color: #8a5cc4;text-align: center;">
                                            <label style="font-size: x-large;font-weight: 600;margin-top: 8px;">
                                              <?php echo e(trans('Grand Total')); ?>

                                              <span id="pro_grand_total_span">
                                                0.00
                                              </span>
                                            </label>

                                            <input type="hidden" name="pro_grand_total" id="pro_grand_total" class="form-control">
                                          </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-5">
                                      <div class="payment-options">
                                        <div class="column-5">
                                            <button style="background: #0984e3" type="button" class="btn btn-custom quick-payment-btn" data-toggle="modal" data-target="#quick-add-payment" id="quick-credit-card-btn"><i class="fa fa-credit-card"></i> Card</button>   
                                        </div>
                                        <div class="column-5">
                                            <button style="background: #00cec9" type="button" class="btn btn-custom quick-payment-btn" data-toggle="modal" data-target="#quick-add-payment" id="quick-cash-btn"><i class="fa fa-money"></i> Cash</button>
                                        </div>
                                        <div class="column-5">
                                            <button style="background-color: #b33771" type="button" class="btn btn-custom quick-payment-btn" data-toggle="modal" data-target="#quick-add-payment" id="quick-cash-card-btn"><i class="fa fa-credit-card-alt"></i> Mix Payment</button>
                                        </div>
                                      </div>
                                    </div>
                                    <!-- <div class="mt-3">
            ...
            <!-- quick payment modal start -->
            <div id="quick-add-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.Finalize Sale')); ?></h5>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
                                        <div class="col-md-6 mt-1">
                                            <label style="color: blue;font-size: x-large;"><?php echo e(trans('file.Recieved Amount')); ?> *</label>
                                            <input type="text" name="quick_paying_amount" class="form-control numkey" required step="any" value="">
                                        </div>
                                        <div class="col-md-6 mt-1">
                                            <label style="color: red;font-size: x-large;"><?php echo e(trans('file.Paying Amount')); ?> *</label>
                                            <input type="text" name="quick_paid_amount" class="form-control numkey"  step="any">
                                        </div>


                                        <div class="col-md-6 mt-1 quick_by_cc">
                                            <label style="color: grey;font-size: x-large;"><?php echo e(trans('By Cash')); ?> *</label>
                                            <input type="text" name="quick_by_cash" id="quick_by_cash" class="form-control numkey" step="any" value="">
                                        </div>
                                        <div class="col-md-6 mt-1 quick_by_cc">
                                            <label style="color: orange;font-size: x-large;"><?php echo e(trans('By Card')); ?> *</label>
                                            <input type="text" name="quick_by_card" id="quick_by_card" class="form-control numkey" step="any" value="">
                                        </div>


                                        <div class="col-md-6 mt-1">
                                            <label style="color: green;font-size: x-large;"><?php echo e(trans('file.Change')); ?> : </label>
                                            <p id="quick_change" class="ml-2">0.00</p>
                                        </div>
                                        <div class="col-md-6 mt-1">
                                            <input type="hidden" name="quick_paid_by_id">
                                            <label><?php echo e(trans('file.Paid By')); ?></label>
                                            <select name="quick_paid_by_id_select" class="form-control selectpicker">
                                                <option value="1">Cash</option>
                                                <option value="3">Credit Card</option>
                                                <option value="3">Debit Card</option>
                                                <option value="7">Mix Payment</option>
                                        ...
                                        <div class="form-group col-md-12">
                                            <label><?php echo e(trans('file.Payment Note')); ?></label>
                                            <textarea id="quick_payment_note" rows="2" class="form-control" name="quick_payment_note"></textarea>
                                        </div> 
                                    </div>
                                    <div class="row">
                                       <div class="col-md-6 form-group">
                                            <label><?php echo e(trans('file.Sale Note')); ?></label>
                                            <textarea rows="3" class="form-control" name="quick_sale_note"></textarea>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label><?php echo e(trans('file.Staff Note')); ?></label>
                                            <textarea rows="3" class="form-control" name="quick_staff_note"></textarea>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                        <button id="submit-btn" type="submit" class="btn btn-primary"><?php echo e(trans('file.submit')); ?></button>
                                ...
                                <div class="col-md-2 quick_qc" data-initial="1">
                                    <h4><strong><?php echo e(trans('file.Quick Cash')); ?></strong></h4>
                                    <button class="btn btn-block btn-primary quick_qc-btn sound-btn" data-amount="5" type="button">5</button>
                                    <button class="btn btn-block btn-primary quick_qc-btn sound-btn" data-amount="10" type="button">10</button>
                                    <button class="btn btn-block btn-primary quick_qc-btn sound-btn" data-amount="20" type="button">20</button>
                                    <button class="btn btn-block btn-primary quick_qc-btn sound-btn" data-amount="50" type="button">50</button>
                                    <button class="btn btn-block btn-primary quick_qc-btn sound-btn" data-amount="100" type="button">100</button>
                                    <!-- <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="500" type="button">500</button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="1000" type="button">1000</button> -->
                                    <button class="btn btn-block btn-danger quick_qc-btn sound-btn" data-amount="0" type="button"><?php echo e(trans('file.Clear')); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(document).on('click', '#clear_products', function(){
      $('.product-list').html('');
      $('#product-table_paginate').html('');
    });
  });
...
{
    $.ajax({
      url:"<?php echo e(route('sale.action')); ?>",
      method:'GET',
