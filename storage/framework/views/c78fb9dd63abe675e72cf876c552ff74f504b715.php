                            ...
                            <div class="navbar-holder d-flex align-items-center justify-content-between">
                                ...
                                <div class="navbar-header">
                                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                        ...
                                        <li class="nav-item">
                                            <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="dripicons-user"></i> <span><?php echo e(ucfirst(Auth::user()->name)); ?></span> <i class="fa fa-angle-down"></i></a>
                                    ...
                                    <table id="quick_table" class="table table-hover table-striped order-list table-fixed">
                                        ...
                                        <!--<tbody>
                                            <tr>
                                                ...
                                                <td class="col-sm-2" style="padding: 4px;padding-bottom: 0px;">
                                                    <select class="" style="width: 100%;padding: 7px 4px;border: 1px solid #e9ecef;border-radius: 5px;">
                                                ...
                                                <td class="col-sm-2" style="padding: 4px;padding-bottom: 0px;">
                                                    <div class="form-group">
                                                        <select name="edit_tax_rate" class="" style="width: 100%;padding: 7px 4px;border: 1px solid #e9ecef;border-radius: 5px;">
                                                            <?php $__currentLoopData = $tax_name_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($key); ?>"><?php echo e($name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                ...
                                                <td class="col-sm-1" style="padding: 4px;padding-bottom: 0px;">
