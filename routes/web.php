...
Route::get('super/admin/login', 'Auth\RegisterController@showSuperLoginForm')->name('showSuperLoginForm');
...
Route::group(['middleware' => ['auth', 'active']], function() {
    ...
    // quick sale route start
	Route::post('sales/sale-data-quick', 'SaleController@quickSaleData');
	Route::get('sales/quick_product_sale/{id}','SaleController@quickProductSaleData');
	Route::post('sales/quickdeletebyselection', 'SaleController@quickDeleteBySelection');
	Route::get('sales/view-quick-sale', 'SaleController@view_quick_sale')->name('sale.view_quick_sale');
	Route::get('sales/action', 'SaleController@action')->name('sale.action');
	// quick sale route end
	...
	Route::get('sales/gen_quick_invoice/{id}', 'SaleController@genQuickInvoice')->name('sale.quick_invoice');
	Route::get('sale/demo_invoice', 'SaleController@genDemoInvoice');
	Route::post('quick_store', 'SaleController@quick_store');
	...
	Route::get('managecommission/get-subcategory/{id}','ManagecommissionController@getsubCat')->name('managecommission.getsubCat');
});
