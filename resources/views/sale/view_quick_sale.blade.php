...
<div id="view-payment" 3 tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
...
<script type="text/javascript">
    ...
    function saleDetails(sale){
        ...
        var htmlfooter = '<p><strong>{{trans("file.Sale Note")}}:</strong> '+sale[23]+'</p><p><strong>{{trans("file.Staff Note")}}:</strong> '+sale[24]+'</p><p><strong>{{trans("Payment Note")}}:</strong> '+sale[31]+'</p><p><strong>{{trans("Payment Method")}}:</strong> '+sale[30]+'</p><p><strong>{{trans("By Cash")}}:</strong> '+sale[32]+'</p><p><strong>{{trans("By Card")}}:</strong> '+sale[33]+'</p><p><strong>{{trans("Change")}}:</strong> '+sale[34]+'</p><strong>{{trans("file.Created By")}}:</strong><br>'+sale[25]+'<br>'+sale[26];
