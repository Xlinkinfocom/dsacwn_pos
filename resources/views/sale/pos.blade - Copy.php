        ...
        <div class="row">
            ...
            <div class="col-md-6">
                        ...
                        <div class="navbar-holder d-flex align-items-center justify-content-between">
                          ...
                          <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            <li class="nav-item">
                              ...
                              ?>
                              @if($add_quick_permission_active)
    			...
    			<div class="row">
                    ...
                    <div class="col-md-3">
                        <!-- <button class="btn btn-block btn-danger" id="featured-filter">{{trans('No Sell')}}</button> -->
                        <a href="{{url('sale/demo_invoice')}}" class="btn btn-block btn-danger">{{trans('Drawer Open')}}</a>
                    </div>
                    <div class="col-md-3">
                        <button class="btn btn-block btn-success" id="clear_products">{{trans('Clear')}}</button>
                    </div>
            ...
            <div id="quick_sale" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left" data-backdrop="static" data-keyboard="false">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 id="exampleModalLabel" class="modal-title">{{trans('Quick Sale')}}</h5>
                                    ...
                                    <table id="quick_table" class="table table-hover table-striped order-list table-fixed">
                                      <thead>
                                        <tr>
                                          ...
                                          <th class="col-sm-2">{{trans('file.Price')}}</th>
                                          <th class="col-sm-2">{{trans('Unit')}}</th>
                                          <th class="col-sm-2">{{trans('Tax Rate')}}</th>
                                          <th class="col-sm-1">{{trans('Qty')}}</th>
                                          <th class="col-sm-3">{{trans('file.Subtotal')}}</th>
                                        </tr>
                                      </thead>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-2 quick_qc" data-initial="1">
                                    ...
                                    <!-- <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="500" type="button">500</button>
                                    <button class="btn btn-block btn-primary qc-btn sound-btn" data-amount="1000" type="button">1000</button> -->
                                    <button class="btn btn-block btn-danger quick_qc-btn sound-btn" data-amount="0" type="button">{{trans('file.Clear')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
